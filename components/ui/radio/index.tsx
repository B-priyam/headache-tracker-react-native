...
const radioLabelStyle = tva({
  base: "text-typography-600 data-[checked=true]:text-blue-500 data-[hover=true]:text-typography-900 data-[hover=true]:data-[disabled=true]:text-blue-500 data-[hover=true]:data-[disabled=true]:data-[checked=true]:text-blue-500 data-[active=true]:text-blue-500 data-[active=true]:data-[checked=true]:text-blue-500 data-[disabled=true]:opacity-40 web:select-none",
  parentVariants: {
    size: {
      "2xs": "text-2xs",
      xs: "text-xs",
